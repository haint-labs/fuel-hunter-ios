...
//		mapAnimationView.leftAnchor.constraint(equalTo: leftAnchor, constant: 30).isActive = true
//		mapAnimationView.rightAnchor.constraint(equalTo: rightAnchor, constant: -30).isActive = true
