...
class AppLanguageRouter: NSObject, AppLanguageRoutingLogic, AppLanguageDataPassing {
	...
	//}
	// MARK: Navigation
	//func navigateToSomewhere(source: AppLanguageViewController, destination: SomewhereViewController)
	//{
	//  source.show(destination, sender: nil)
	//}  
	// MARK: Passing data
	//func passDataToSomewhere(source: AppLanguageDataStore, destination: inout SomewhereDataStore)
	//{
