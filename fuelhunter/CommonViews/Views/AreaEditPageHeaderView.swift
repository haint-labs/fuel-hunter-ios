...
protocol AreaEditPageHeaderViewDisplayLogic {
    func setSectionIndex(_ sectionIndex: Int)
}

class AreaEditPageHeaderView: FontChangeHeaderFooterView, AreaEditPageHeaderViewDisplayLogic {
