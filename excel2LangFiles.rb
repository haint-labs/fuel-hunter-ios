...
1.upto(excel.last_row) do |line|
  ...
  begin
     ...
     if File.directory?("fuelhunter/Localization/#{languageArray[fileIndex]}.lproj")
     puts "Directory fuelhunter/Localization/#{languageArray[fileIndex]}.lproj exists."
     else
       puts "Creating fuelhunter/Localization/#{languageArray[fileIndex]}.lproj directory."
       Dir.mkdir("fuelhunter/Localization/#{languageArray[fileIndex]}.lproj")
     end

     puts "Opening file Localizable.strings for writing"
     output = File.open("fuelhunter/Localization/#{languageArray[fileIndex]}.lproj/Localizable.strings", "w")
